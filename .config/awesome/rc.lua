...
globalkeys = awful.util.table.join(
    ...
    awful.key({         "Control" }, "\\", function() awful.spawn("dmenu_run") end,
    ...
    awful.key({                   }, "Print", function () awful.spawn("scrot '%Y%m%d_%H%M%S_$wx$h_scrot.png'") end,
              {description = "print screen", group = "screenshot"}),
    awful.key({ modkey,           }, "Print", function () awful.spawn("scrot '%Y%m%d_%H%M%S_$wx$h_scrot.png' -s") end,
              {description = "print selected screen", group = "screenshot"}),

    awful.key({                   }, "XF86AudioMute", function () awful.spawn("amixer -q set Master toggle") end,
              {description = "mute volue", group = "volume"}),
    awful.key({                   }, "XF86AudioLowerVolume",
        function ()
            awful.spawn("amixer -q set Master 2%-")
            awful.spawn("mplayer -noconfig all /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
        end,
        {description = "lower volue", group = "volume"}),
    awful.key({                   }, "XF86AudioRaiseVolume",
        function ()
            awful.spawn("amixer -q set Master 2%+")
            awful.spawn("mplayer -noconfig all /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
        end,
        {description = "raise volue", group = "volume"})
...
awful.spawn("compton -CGb --no-fading-openclose")
awful.spawn("xset -b")
awful.spawn("xset -dpms")
awful.spawn("xset s off")
awful.spawn("xset r rate 500 100")
awful.spawn("feh --bg-fill /home/r6eve/picts/bg.png")
awful.spawn("fcitx-autostart")
-- awful.spawn("xmodmap /home/r6eve/.Xmodmap")
