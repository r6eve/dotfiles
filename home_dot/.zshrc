...
setopt PROMPT_SUBST
NEWLINE=$'\n'
PROMPT="%B%K{blue}%F{green}@%m%k%b%f%K{blue}%F{green}[%39<...<%~]%f%k%1(v|%F{green}%1v%f|)%K{red}%F{green}%(?..[%?])%f%k${NEWLINE}%B%K{blue}%F{green}( l_l )%f%k%b "
PROMPT2="%B%K{red}%F{green}@%m%k%b%f%K{red}%F{green}[%39<...<%~]%f%k%1(v|%F{green}%1v%f|)%K{red}%F{green}%(?..[%?])%f%k${NEWLINE}%B%K{red}%F{green}( l_l )%f%k%b "
